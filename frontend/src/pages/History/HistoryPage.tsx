  ...
  return (
    <div className="min-h-screen bg-[#f4f7fa]">
      ...
      <main className="mx-auto max-w-7xl px-4 py-8">
        <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-gray-500">
              Dữ liệu từ API <code className="text-xs bg-gray-100 px-1 rounded">GET /bookings?role=renter</code>
            </p>
          </div>
          <Link
            to="/"
        ...
        {loading ? (
          <p className="text-gray-500 text-center py-16">Đang tải…</p>
        ) : bookings.length === 0 ? (
          <div className="rounded-3xl border border-dashed border-gray-300 bg-white py-20 text-center">
            ...
            <p className="mt-2 text-sm text-gray-500">Hãy thêm thiết bị vào giỏ và thanh toán.</p>
            <Link
              to="/"
                ...
                >
                  <div className="flex flex-col gap-5 lg:flex-row">
                    <img
                      src={lensImage(b)}
                      alt=""
                      className="h-48 w-full rounded-2xl object-cover lg:h-40 lg:w-56 bg-gray-100"
                    />
                    <div className="flex flex-1 flex-col">
                      <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                        <div>
                          ...
                          <h2 className="mt-3 text-2xl font-bold text-gray-900">{lens?.title || 'Thiết bị'}</h2>
